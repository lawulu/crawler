...
public class ErrorRedisScheduler extends DuplicateRemovedScheduler implements MonitorableScheduler, DuplicateRemover {
    ...
    public ErrorRedisScheduler(String host) {
        this(new JedisPool(new JedisPoolConfig(), host));
    }

    public ErrorRedisScheduler(JedisPool pool) {
        this.pool = pool;
